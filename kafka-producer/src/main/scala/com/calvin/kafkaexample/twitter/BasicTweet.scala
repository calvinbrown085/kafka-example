...
case class BasicTweet( //comes from https://developer.twitter.com/en/docs/tweets/data-dictionary/overview/tweet-object
    ...
    new Decoder[BasicTweet] {
      ...
      final def apply(c: HCursor): Decoder.Result[BasicTweet] = {
        for {
          ...
          BasicTweet(created, id, text, quoted, replied, retweeted, favorited)
        }
      }
